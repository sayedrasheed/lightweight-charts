...
import { timestampConverter} from '../../src/model/horz-scale-behavior-time/time-utils';
...
export class CustomBox {
	...
	public constructor(series: ISeries<SeriesType>, options: BoxOptions) {
		this._series = series;
	...
	public xCoord(time: UTCTimestamp): Coordinate | null {
		...
		timestampConverter
		const timeIndex = timeScale.timeToIndex(timestampConverter(time), true);
